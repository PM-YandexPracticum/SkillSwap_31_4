...
import { SkillCardsList } from './SkillCardsList';
import { Card } from '../../shared/ui/Card';

const meta = {
	title: 'Widgets/SkillCardsList',
	component: SkillCardsList,
	tags: ['autodocs'],
	parameters: {
		layout: 'centered',
		backgrounds: {
...
} satisfies Meta<typeof SkillCardsList>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Base: Story = {
	render: (args) => <SkillCardsList {...args} />,
	args: {
		title: 'Популярное',
		SkillCard: Card,
		SkillCardsProps: [
