...
import type { SkillCardsListInfiniteProps } from '../type';
import styles from '../SkillCardsList.module.scss';
import { ButtonUI } from '../../../shared/ui';

export const SkillCardsListInfinite: React.FC<SkillCardsListInfiniteProps> = (
	props: SkillCardsListInfiniteProps
) => {
	const {
		SkillCard,
		SkillCardsProps,
	...
	return (
		<section className={styles.container}>
			<nav className={styles.listHeader}>
				...
				{isHasButtonNew && (
					<ButtonUI onClick={onClickButtonNew} color='tertiary' width='187px'>
						<svg
							width='24'
							height='24'
							viewBox='0 0 24 24'
